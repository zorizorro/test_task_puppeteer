...
(async () => {
    ...
    const items = await page.$$(listRegions); // '.item' - селектор отдельных элементов списка
    ...
    if (oldPriceelem) {
        ...
        console.log(`олдцена`, oldPriceelemValue)
    }
    ...
    const directoryPath = './screens/'; // Например: './мой_каталог/'
